...
public class SmsUtils {
    ...
    public void sendSmsTest(String phone, String code, String signName, String template){
        logger.info("接收到了{}，{}，{}，{}",phone,code,signName,template);
    }
